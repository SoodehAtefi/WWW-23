...
from HEADER import *
data=pd.read_csv('../data/Firefox/data_to_collect_weakness_langs.csv', na_filter=False)
CVE_List=data[(data['CVE_final']!='NA')].CVE_final.tolist()
...
# df_cwe.to_csv('../data/Firefox/CWE_Categories_Firefox.csv')

####Broadtype_Names (CWE with names)
Data = []
Nature = []
Name = []
Type = []
...
# CWE_Names.to_csv('../data/Firefox/CWE_with_Name_Firefox.csv')
